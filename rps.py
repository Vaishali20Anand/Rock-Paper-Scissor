...
def MatchProcess():
    ...
    if com_choice == 1:
        ...
        com_img.configure(image=com_scissor)
        ComputerScissor()
...
com_img = Label(root,image=blank_img)
lbl_player = Label(root,text="YOU")
...
com_img.grid(row=2,column=3, pady=20)
...
btn_quit = Button(root, text="  Exit from Game", command=ExitApp)
